        ...
        <div class="container-fluid">
            <div class="bg-white">
                <div class="d-flex justify-content-between align-items-center p-3">
                    <h4 class="h4 font-weight-bold text-primary">Réponses aux commentaires</h4>
                </div>
                <?php if ($comments) : ?>
                                ...
                                <?php foreach ($comments as $comment) : ?>
                                    <tr>
                                        ...
                                        <td class="d-table-cell">
                                            <a href="/admin/comment-reply/show/<?= $comment['id'] ?>" class="btn btn-secondary btn-sm"><i class="fa fa-eye"></i></a>
                                            <a href="/admin/comment-reply/edit/<?= $comment['id'] ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                            <a href="/admin/comment-reply/delete/<?= $comment['id'] ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>

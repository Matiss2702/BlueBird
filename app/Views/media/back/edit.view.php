<div class="card w-100 mb-3">
    ...
    <div class="container mt-5">
        <div class="w-75">
            <form action="/admin/media/update/<?=$media->getId()?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="<?= $old->name ?? $media->getName() ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="slug" name="slug" class="form-control" value="<?= $old->slug ?? $mediaSlug ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="alt" name="alt" class="form-control" value="<?= $old->alt ?? $media->getAlt() ?>">

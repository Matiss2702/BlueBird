<div class="card w-100">
    ...
    <h4 class="card-title">Details du film #<?= $movie['id'] ?> - <?= $movie['title'] ?></h4>
        ...
        <div class="w-100">
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control" value="<?= $movie['title'] ?>" readonly>
                </div>
                <div class="form-row mb-4">
                    <div class="col">
                        <label for="release_date">Date de sortie</label>
                        <input type="date" id="release_date" name="release_date" class="form-control" value="<?=$movie['release_date'] ?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control" readonly rows="10"><?= $movie['description'] ?></textarea>
                </div>
            </form>
        </div>
    </div>
